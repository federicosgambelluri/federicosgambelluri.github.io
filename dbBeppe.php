 ...
 // $password     = "studente";
  ...
  try {
     // $conn = new PDO("mysql:host=$servername;dbname=$databasename", $username, $password);
      ...
      $stmt = $conn->prepare("SELECT * from Giuseppe ");
           $stmt->execute();
...
echo "<div id='customers'>";
    ...
    echo "<tr><th>Codice</th><th>Titolo</th><th>Artista-Gruppo</th><th>Anno di pubblicazione</th><th>Genere</th><th>Dimensione</th><th>Paese</th><th>Prezzo</th><th>Casa Discografica</th><th>Locazione</th></tr>"; //colonne della tabella
...
echo  "<td style='width:150px;border:1px solid black;'>".$riga['Dimensioni']."<//td>";
...
echo  "<td style='width:150px;border:1px solid black;'>".$riga['Locazione']."<//td>";

...
class metodi
{
    ...
    function controllo() //Controllo credenziali
    {
        ...
        {
            if (($_SESSION['pass'] == "Glibrary123" && $_SESSION['username'] == "giuseppe.sgambelluri") || ($_SESSION['pass'] == "Flibrary123" && $_SESSION['username'] == "federico.sgambelluri")) // Controllo le credenziali? 
            {

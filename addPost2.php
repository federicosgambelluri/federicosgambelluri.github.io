	...
	<body>
		<center>
			...
			if (isset($_POST['codice']) && isset($_POST['titolo']) && isset($_POST['artista'])&& isset($_POST['anno'])&& isset($_POST['genere'])&& isset($_POST['pollici'])&& isset($_POST['rpm'])&& isset($_POST['paese'])&& isset($_POST['prezzo'])&& isset($_POST['casa'])) {
				...
				$sql = 'INSERT INTO LP(Codice, Titolo, ArtistaGruppo, AnnoPubblicazione,Genere,Pollici,RPM,Paese,Prezzo,CasaDiscografica) VALUES(:codice, :titolo, :artista, :anno, :genere, :pollici, :rpm, :paese, :prezzo, :casa)';
				try {
